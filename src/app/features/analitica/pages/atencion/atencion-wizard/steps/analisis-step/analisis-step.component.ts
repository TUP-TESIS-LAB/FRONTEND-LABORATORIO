  ...
  template: `
    <div class="flex flex-col h-full min-h-0 space-y-4">
      <lab-analysis-picker
        ...
        <!-- Va en la esquina DERECHA de la fila, alineado con el borde derecho de la tabla:
             el buscador crece (flex-1) y lo empuja hasta el final. La alineación con la tabla
             es el punto — no acercarlo al buscador (se probó y no era lo pedido).
