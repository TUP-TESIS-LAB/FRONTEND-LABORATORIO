...
@Component({
  selector: 'app-horarios-tab',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [ReactiveFormsModule, TableModule, ButtonModule, SelectModule, InputTextModule],
  templateUrl: './horarios-tab.component.html',
  styleUrl: './horarios-tab.component.scss',
})
export class HorariosTabComponent implements OnInit {
